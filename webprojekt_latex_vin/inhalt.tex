\chapter{Registrierung und Login}
...
\newline
\includegraphics[width=1\textwidth]{abb11.png}
\newline
...
\newline
\includegraphics[width=1\textwidth]{abb12.png}
\newline
...
\newline	
\includegraphics[width=1\textwidth]{abb13.png}
\newline
...
\newline	
\includegraphics[width=1\textwidth]{abb14.png}
\newline
...
\newline	
Die Login.php Datei beginnt mit der Definition eines HTML-Formulars. Dabei wird nur Username und Passwort als Eingabefelder erstellt, wie folgendes Coding zeigt:

\includegraphics[width=1\textwidth]{abb15.png}
\newline
Wie beim Registrieren wird auch hier eine Datenbankverbindung mit der MySQL-Datenbank erstellt und \"uberpr\"uft. Wennn die eingegebenen Daten i der Datenbank vorliegen, dass heißt der Username vorhanden ist und das Passwort richtig ist, wird das beste Ergebnis des Users aus der Datenbank ausgelesen und mittels echo-Kommando ausgegeben. Die eben beschriebene Funktionalit\"at ist mittels folgendem Coding implementiert worden: 
\newline	
\includegraphics[width=1\textwidth]{abb16.png}
\newline
\chapter{Websockets}
Eines der Ziele des Projekts war die Implementierung von Websockets, diese wurde mittels \textit{Node.js.} und der Bibliothek \textit{nodejs-websocket}
auf der Serverseite und mittels Javascript auf der Clientseite umgesetzt. Der Server wartet auf eingehende Verbindungen auf dem Port 8001. Sobald sich ein Client verbunden hat wird eine Event gefeuert und der Server sendet seine Systemzeit \"uber die Websocket-Verbindung an den Client, wie aus folgendem Coding zu entnehmen ist:  
\newline
\includegraphics[width=1\textwidth]{abb02.png}
\newline
...
\newline
\includegraphics[width=1\textwidth]{abb03.png}
\newline
Das Ergebnis sieht wie folgt aus:
\newline
\includegraphics[width=1\textwidth]{abb17.png}
\newline
\chapter{Canvas}
...
\newline
\includegraphics[width=1\textwidth]{abb04.png}
\newline
...
\newline
\includegraphics[width=1\textwidth]{abb05.png}
\newline
...
\newline
\includegraphics[width=1\textwidth]{abb06.png}
\newline
...
\newline
\includegraphics[width=0.6\textwidth]{abb07.png}
\newline
...
\newline
\includegraphics[width=1\textwidth]{abb08.png}
\newline
Das Endergebnis l\"asst sich in nachfolgender Abbildung bewundern:
\newline
\includegraphics[width=0.7\textwidth]{abb09.png}
\newline
...
\newline
\includegraphics[width=1\textwidth]{abb10.png}
\newline
...
\newline
\includegraphics[width=1\textwidth]{abb18.png}
\newline
...
\newline
\includegraphics[width=1\textwidth]{abb19.png}
\newline
...
\newline
\includegraphics[width=0.6\textwidth]{abb20.png}
\newline
